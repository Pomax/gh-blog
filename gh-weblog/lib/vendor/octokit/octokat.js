// https://github.com/philschatz/octokat.js/blob/3209c273618c9b22737fb3c1956b76f0c523d564/dist/octokat.js
let Octokat;
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports =
          ...
          _defineProperty(_module$exports, "repositories", REPO_FIELDS),
          _defineProperty(_module$exports, "licenses", false),
          _defineProperty(_module$exports, "authorizations", {
            clients: false,
          }),
        ...
        var toPromise = function toPromise(orig) {
          return function () {
            ...
            if (typeof last === "function") {
              ...
              throw new Error(
                "You must specify a callback or have a promise library loaded"
              );
            }
          };
        };
                  ...
                  forOwn(this._syncVerbs, function (verbFunc, verbName) {
                    obj[verbName] = function () {
                      var makeRequest = function makeRequest() {
                        ...
                        var _verbFunc = verbFunc.apply(
                          undefined,
                          [path].concat(originalArgs)
                        );
                        ...
                        return _this._requester.request(
                          method,
                          path,
                          data,
                          options
            ...
            create: function create(path, data, contentType) {
              if (contentType) {
                return {
                  ...
                  path: path,
                  data: data,
                  options: { isRaw: true, contentType: contentType },
                };
              } else {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var ALL_PLUGINS = [
          __webpack_require__(18), // re-chain methods when we detect an object (issue, comment, user, etc)
        ...
        var Octokat = function Octokat() {
          ...
          if (clientOptions.disableHypermedia) {
            deprecate(
              "Please use the clientOptions.plugins array and just do not include the hypermedia plugin"
            );
            clientOptions.plugins = clientOptions.plugins.filter(function (
              plugin
            ) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function (global) {
          ...
          var OctokatBase = function OctokatBase() {
            ...
            if (
              typeof disableHypermedia === "undefined" ||
              disableHypermedia === null
            ) {
            ...
            var request = function request(method, path, data) {
              var options =
                arguments.length > 3 && arguments[3] !== undefined
                  ? arguments[3]
                  : { raw: false, isBase64: false, isBoolean: false };
              var cb = arguments[4];
            ...
            instance._parseWithContextPromise = function (path, context) {
              ...
              var responseMiddlewareAsyncs = plus.map(
                plus.filter(plugins, function (_ref) {
            ...
            instance.fromUrl = function (path) {
              ...
              return instance._fromUrlWithDefault.apply(
                instance,
                [path, defaultFn].concat(args)
              );
            };
            ...
            instance._fromUrlCurried = function (path, defaultFn) {
              var fn = function fn() {
                ...
                if (defaultFn && templateArgs.length === 0) {
                  ...
                  return instance.fromUrl.apply(
                    instance,
                    [path].concat(templateArgs)
                  );
                }
              };
            ...
            instance.status = instance.fromUrl(
              "https://status.github.com/api/status.json"
            );
            instance.status.api = instance.fromUrl(
              "https://status.github.com/api.json"
            );
            instance.status.lastMessage = instance.fromUrl(
              "https://status.github.com/api/last-message.json"
            );
            instance.status.messages = instance.fromUrl(
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        if (typeof window.fetch === "function") {
          ...
          module.exports = function () {
            throw new Error(
              "Octokat Error: window.fetch function not found. Either use the https://npmjs.com/package/whatwg-fetch polyfill or set Octokat.Fetch variable to be the fetch function"
            );
          };
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = (function () {
          function Requester(_instance) {
            ...
            this._pluginMiddlewareAsync = map(
              filter(plugins, function (_ref) {
          ...
          _createClass(Requester, [
            {
              ...
              value: function request(method, path, data) {
                ...
                var headers = {
                  Accept:
                    this._clientOptions.acceptHeader || "application/json",
                ...
                return prev.then(function (acc) {
                  ...
                  var fetchArgs = {
                    ...
                    headers: headers,
                    body:
                      (!options.isRaw && data && JSON.stringify(data)) || data,
                  };

                  var eventId = ++EVENT_ID;
                  __guardFunc__(_this._emit, function (f) {
                    return f("start", eventId, {
                      method: method,
                      path: path,
                      data: data,
                      options: options,
                    ...
                    .then(function (response) {
                      ...
                      if (_this._emit) {
                        if (response.headers.get("X-RateLimit-Limit")) {
                          var rateLimit = parseFloat(
                            response.headers.get("X-RateLimit-Limit")
                          );
                          var rateLimitRemaining = parseFloat(
                            response.headers.get("X-RateLimit-Remaining")
                          );
                          var rateLimitReset = parseFloat(
                          ...
                          if (response.headers.get("X-OAuth-Scopes")) {
                            emitterRate.scopes = response.headers
                              .get("X-OAuth-Scopes")
                              .split(", ");
                          }
                        }
                      ...
                      if (response.status === 302) {
                        ...
                        return dataPromise.then(function (data) {
                          ...
                          return _this._instance._parseWithContextPromise(
                            "",
                            acc
                          );
                        });
        ...
        module.exports = function (url) {
          ...
          if ((arguments.length <= 1 ? 0 : arguments.length - 1) === 0) {
            ...
            if ((arguments.length <= 1 ? 0 : arguments.length - 1) > 1) {
              deprecate(
                "When filling in a template URL pass all the field to fill in 1 object instead of comma-separated args"
              );
            }
            ...
            switch (match[1]) {
              case "/":
                ...
                if (fieldValue) {
                  if (/\//.test(fieldValue)) {
                    throw new Error(
                      "Octokat Error: this field must not contain slashes: " +
                        fieldName
                    );
                  }
                  param = "/" + fieldValue;
              ...
              default:
                ...
                if (templateParams[fieldName]) {
                  ...
                  throw new Error(
                    "Octokat Error: Required parameter is missing: " + fieldName
                  );
                }
            }
                ...
                if (/_url$/.test(key)) {
                  if (/^upload_url$/.test(key)) {
                    ...
                    var defaultFn = function defaultFn() {
                      ...
                      deprecate(
                        "call .upload({name, label}).create(data, contentType)" +
                    ...
                    var fn = function fn() {
                      ...
                      return instance._fromUrlWithDefault.apply(
                        instance,
                        [value, defaultFn].concat(args)
                      )();
                    };
                  } else {
                    var defaultFn = function defaultFn() {
                      deprecate(
                        "instead of directly calling methods like .nextPage(), use .nextPage.fetch()"
                      );
                      return this.fetch();
                    };
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        (function () {
          module.exports = {
            repos:
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/(repos(\/[^\/]+){2}|repositories\/([0-9]+))$/,
            gists: /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/gists\/[^\/]+$/,
            issues:
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/(repos(\/[^\/]+){2}|repositories\/([0-9]+))\/(issues|pulls)\/[^\/]+$/,
            users: /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/users\/[^\/]+$/,
            orgs: /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/orgs\/[^\/]+$/,
            teams: /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/teams\/[^\/]+$/,
            "repos.comments":
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/repos\/[^\/]+\/[^\/]+\/comments\/[^\/]+$/,
          };
        }).call(undefined);
          ...
          _createClass(PathValidator, [
            {
              ...
              value: function requestMiddlewareAsync(input) {
                ...
                if (!URL_VALIDATOR.test(path)) {
                  var err =
                    "Octokat BUG: Invalid Path. If this is actually a valid path then please update the URL_VALIDATOR. path=" +
                    path;
                  console.warn(err);
                }
                return Promise.resolve(input);
        ...
        (function () {
          module.exports = {
            "application/vnd.github.drax-preview+json":
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?(\/licenses|\/licenses\/([^\/]+)|\/repos\/([^\/]+)\/([^\/]+))$/,
            "application/vnd.github.v3.star+json":
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/users\/([^\/]+)\/starred$/,
            "application/vnd.github.cloak-preview+json":
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/search\/commits$/,
            "application/vnd.github.black-cat-preview+json":
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?\/repos(\/[^\/]+){2}\/pulls\/[0-9]+\/(|requested_reviewers|reviews(\/[0-9]+)?|reviews(\/[0-9]+)\/(comments|events|dismissals))$/,
            "application/vnd.github.inertia-preview+json":
              /^(https?:\/\/[^\/]+)?(\/api\/v3)?(\/repos(\/[^\/]+){2}\/projects|\/orgs\/([^\/]+)\/projects|\/projects\/([0-9]+|[0-9]+\/columns|columns|columns\/[0-9]+|columns\/[0-9]+\/moves|columns\/[0-9]+\/cards|columns\/cards\/[0-9]+|columns\/cards\/[0-9]+\/moves))$/,
          };
        }).call(undefined);
          ...
          _createClass(UsePostInsteadOfPatch, [
            {
              ...
              value: function requestMiddlewareAsync(input, cb) {
                var usePostInsteadOfPatch =
                    input.clientOptions.usePostInsteadOfPatch,
                  method = input.method;
          ...
          asyncVerbs: {
            fetchAll: function fetchAll(requester, path) {
              return function (query) {
                ...
                return requester
                  .request("GET", "" + path + toQueryString(query), null, null)
          ...
          _createClass(Pagination, [
            {
              ...
              value: function responseMiddlewareAsync(input) {
                ...
                if (Array.isArray(data)) {
                  data = {
                    items: data.slice(), // Convert to object so we can add the next/prev/first/last link headers
            ...
            },
            {
              ...
              value: function requestMiddlewareAsync(input) {
                ...
                if (cacheHandler.get(method, path)) {
                  input.headers["If-None-Match"] = cacheHandler.get(
                    method,
                    path
                  ).eTag;
                } else {
                  ...
                  // a URL is requested.
                  input.headers["If-Modified-Since"] =
                ...
                if (jqXHR) {
                  ...
                  if (status === 304 || status === 0) {
                    ...
                    if (ref) {
                      ...
                      throw new Error(
                        "ERROR: Bug in Octokat cacheHandler for path '" +
                          method +
                          " " +
                          path +
                          "'. It had an eTag but not the cached response."
                      );
                    }
                  } else {
            ...
            this.verbs = {
              readBinary: function readBinary(path, query) {
                return {
                  method: "GET",
                  path: "" + path + toQueryString(query),
                  options: { isRaw: true, isBase64: true },
                };
              },
            };
          }
