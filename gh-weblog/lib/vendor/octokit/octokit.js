  ...
  Octokit = (function () {
    function Octokit(clientOptions) {
      ...
      notifyStart = function (promise, path) {
        return typeof promise.notify === "function"
          ? promise.notify({
              type: "start",
              path: path,
            })
      ...
      _request = function (method, path, data, options) {
        ...
        promise = newPromise(function (resolve, reject) {
          ...
          return (
            (typeof xhrPromise["catch"] === "function"
              ? xhrPromise["catch"](onError)
              : void 0) || xhrPromise.fail(onError)
          );
        });
      ...
      this.getOrgRepos = function (orgName, type) {
        ...
        return _request(
          ...
          "/orgs/" +
            ...
            "/repos?type=" +
            type +
            "&per_page=1000&sort=updated&direction=desc",
          null
        );
      };
                ...
                return _git
                  ...
                  .then(function (tree) {
                    ...
                    return _git.postTree(tree).then(function (rootTree) {
                      return _git
                        .commit(latestCommit, rootTree, message)
            ...
            return _getRef().then(function (branch) {
              ...
              afterParentCommitShas = function (parentCommitShas) {
                ...
                return allPromises(promises).then(function (newTrees) {
                  return _git
                    .updateTreeMany(parentCommitShas, newTrees)
                    .then(function (tree) {
                      return _git
                        .commit(parentCommitShas, tree, message)
                        .then(function (commitSha) {
                          return _git
                            .updateHead(branch, commitSha)
                            .then(function (res) {
                              return res.object;
                            });
                        });
